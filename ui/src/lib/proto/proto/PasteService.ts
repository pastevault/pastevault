...
export interface PasteServiceClient extends grpc.Client {
...
export interface PasteServiceHandlers extends grpc.UntypedServiceImplementation {
...
export interface PasteServiceDefinition extends grpc.ServiceDefinition {
